...
class CodebuildSrcFileHelper(ResourceCmdHelper):
    ...
    def get_buildspec(self):
        ...
        buildspec_content = [
            ...
            "    on-failure: CONTINUE",
            "    commands:",
            "      - aws s3 cp s3://app-env.tmp.williaumwu.eb6ef/waftuxfpqoddkhis/state/src.waftuxfpqoddkhis.zip /tmp/waftuxfpqoddkhis.zip --quiet",
            "      - mkdir -p /var/tmp/share",
            "      - mkdir -p /var/tmp/share/waftuxfpqoddkhis",
            "      - unzip -o /tmp/waftuxfpqoddkhis.zip -d /var/tmp/share/waftuxfpqoddkhis/",
            "      - rm -rf /tmp/waftuxfpqoddkhis.zip",
            "",
            "  build:",
            "    commands:",
            "      - cd /var/tmp/share/waftuxfpqoddkhis/",
            ...
            "      - aws s3 cp done s3://app-env.tmp.williaumwu.eb6ef/executions/waftuxfpqoddkhis/done",
        ]
